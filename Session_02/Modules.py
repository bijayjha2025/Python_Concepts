...
cowsay.dragon("Hello, I'm a dragon!")
cowsay.tux("Hello, I'm Tux the penguin!")
cowsay.turtle("Hello, I'm a turtle!")
cowsay.stegosaurus("Hello, I'm a stegosaurus!")
cowsay.ghostbusters("Hello, we're the Ghostbusters!")
cowsay.kitty("Hello, I'm a kitty!")
