...
negativeAndZero = [num for num in numbers if num <= 0]
...
flattenedList = [num for sublist in listOfLists for num in sublist]
print(flattenedList)
...
list = [(i, 1, i, i**2, i**3, i**4, i**5) for i in range(11)]
print(list)
